...
### Projects margiet-one =BE=
To run the dev server for app, use:

```sh
npx nx serve margiet-one
```

To create a production bundle:

```sh
npx nx build margiet-one
```
...
```sh
npx nx g @nx/angular:library mylib
```
